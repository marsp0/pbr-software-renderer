...
static void test_rasterize_multiple_triangles_in_order()
{
    // +--------------------+
    // /                    /
    // /                    /
...
static void test_rasterize_multiple_triangles_in_reverse_order()
{
    // +--------------------+
    // /                    /
    // /                    /
    ...
    // assert first triangle
    vec_t points[25] = {vec_new(1.f, 1.f, 0.5f),
                        vec_new(2.f, 1.f, 0.5f),
                        vec_new(3.f, 1.f, 0.5f),
                        vec_new(4.f, 1.f, 0.5f),
                        vec_new(5.f, 1.f, 0.5f),
    ...
    // assert second triangle
    vec_t points2[4] = {vec_new(7.f, 3.f, 0.6f),
                        vec_new(6.f, 4.f, 0.6f),
                        vec_new(6.f, 5.f, 0.6f),
                        vec_new(6.f, 6.f, 0.6f)};
...
void test_rasterizer()
{
    ...
    TEST_CASE(test_rasterize_multiple_triangles_in_order);
