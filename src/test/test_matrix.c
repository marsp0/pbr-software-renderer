...
static void test_x_axis_rotation()
{
    ...
    vec_t v = vec_new(0.f, 0.f, 1.f);

    vec_t actual = mat_mul_vec(r, v);

    ASSERT_VECTOR(vec_new(0.f, -1.f, 0.f), actual);
}
