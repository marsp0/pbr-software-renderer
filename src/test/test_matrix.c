...
static void test_mat_translate()
{
    mat_t actual = mat_translate(vec4_new(1.f, 2.f, 3.f));
    mat_t expected = mat_new_identity();
    expected.data[0][3] = 1.f;
    expected.data[1][3] = 2.f;
    expected.data[2][3] = 3.f;
