...
{
    vec3_t v1       = vec3_new(1.f, 2.f, 3.f);
    vec3_t v2       = vec3_new(4.f, 5.f, 6.f);
    vec3_t actual   = vec3_hadamard(v1, v2);
    vec3_t expected = vec3_new(4.f, 10.f, 18.f);
...
{
    vec3_t v        = vec3_new(-2.5f, 2.f, 0.5f);
    vec3_t actual   = vec3_clamp(v, 0.f, 1.f);
    vec3_t expected = vec3_new(0.f, 1.f, 0.5f);
...
{
    float s             = 1.f;
    vec3_t actual       = vec3_from_scalar(s);
    vec3_t expected     = vec3_new(1.f, 1.f, 1.f);
